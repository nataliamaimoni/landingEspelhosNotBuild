var pagination =  function(){	
    ...
    $('.switch--final--composition, .switch--final--choice, #step4 .composition-view, #step4 .other').addClass('hide');
    $('.switch--final--other').removeClass('hide');
	});

	$('#step4 .previous').on('click', function(){
    $('#step4 .composition-view, .switch--final--choice').removeClass('hide');
